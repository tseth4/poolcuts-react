...
export const boundBookAppointment = (book: NewBooking, user: User | FBUser) => (dispatch: Dispatch<AppActions>, getState: () => AppState) => {
  bookAppointmentService(book, user).then(res => {
...
export const boundUnsetSuccessMessage = () => (dispatch: Dispatch<AppActions>, getState: () => AppState) => {
  console.log("bound un setting")
  dispatch(deleteSuccessfullBooking());
}

export const boundUnsetCancelSuccessMessage = () => (dispatch: Dispatch<AppActions>, getState: () => AppState) => {
...
export const boundCancelBooking = (id: number, user: any) => (dispatch: Dispatch<AppActions>, getState: () => AppState) => {
  console.log("bound canceling")
  cancelAppointmentService(id, user).then(res => {
